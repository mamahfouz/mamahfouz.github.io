    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-our-paper-learning-to-manage-investment-portfolios-beyond-simple-utility-functions-was-presented-at-icaif-2025-in-singapore",
          title: 'Our paper, “Learning to Manage Investment Portfolios beyond Simple Utility Functions,” was presented...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://dblp.org/pid/237/9962.html", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%65@%6D%61%6D%61%68%66%6F%75%7A.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/mamahfouz", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/mahfouz1991", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=FAusNh8AAAAJ", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/Mahfouz1991", "_blank");
        },
      },{
      id: 'light-theme',
